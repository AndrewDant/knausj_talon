...
formatter_list = [
    ...
    CodeFormatter("ALL_CAPS_SNAKE_CASE", "_", lambda text: text.upper(), lambda text: text.upper()),
    CodeFormatter("ALL_CAPS_NO_SPACES", "", lambda text: text.upper(), lambda text: text.upper()),
]
