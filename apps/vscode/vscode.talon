...
(window reload | reload window): user.vscode("workbench.action.reloadWindow")
...
bar GitLab: user.vscode("workbench.view.extension.gitlab-workflow")
...
file copy (local|relative) [path]: user.vscode("copyRelativeFilePath")
...
(language switch|switch language): user.vscode("workbench.action.editor.changeLanguageMode")
...
terminal (trash|kill): user.vscode("workbench.action.terminal.kill")
