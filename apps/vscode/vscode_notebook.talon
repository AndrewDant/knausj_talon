...
render all:          user.vscode("notebook.renderAllMarkdownCells")

# Execution
(cell run|run cell):                   user.vscode("notebook.cell.execute")
cell run above:             user.vscode("notebook.cell.executeCellsAbove")
run all:                    user.vscode("notebook.execute")
...
cell toggle [line] numbers:          user.vscode("notebook.cell.toggleLineNumbers")

# Navigation
cell top:                   user.vscode("notebook.focusTop")
cell (up|previous):                    user.vscode("notebook.focusPreviousEditor")
cell (down|next):                  user.vscode("notebook.focusNextEditor")
...
# Export
export to pdf: user.vscode("jupyter.exportToPDF")
